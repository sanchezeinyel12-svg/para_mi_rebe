...
(function initMensajeSorpresa() {
  ...
  overlay.innerHTML = `
    <div class="sorpresa-card-pop">
      ...
      <div class="sorp-msg">
     Solo te pido de corazón que esos ojitos nunca pierdan su brillo, y esa sonrisa que nunca se apague, quiero verte feliz siempre a mi lado mi novia linda ❤️.<br>
      </div>
