...
(function initMensajeSorpresa() {
  ...
  overlay.innerHTML = `
    <div class="sorpresa-card-pop">
      ...
      <div class="sorp-msg">
   Mi bella esposita te quiero tu angeeeeel ❤️ <br>
      </div>
...
(function initMesSection() {

  /* ── Contador desde el 17 de abril (cuando le pediste ser tu novia) ── */
  const START_DATE = new Date('2026-04-17T00:00:00');


  /* ── Reveal de polaroids al hacer scroll ── */
  const polaroids = document.querySelectorAll('.mes-polaroid');
  ...
  /* ── Toque para móvil (toggle flip en vez de hover) ── */
  polaroids.forEach(p => {
    ...
    const POLAROIDS = [
        ...
        },
        {
        ...
        },
          {
            photo: "ojazos.jpeg",
            emoji: "⭐",
            caption: "Me encantan tus ojos mi amor ❤️",
            note: "AMO ❤️",
            color: "#e8d8f8",
            rot: "2deg"
        },
        {
            photo: "tesorito.jpeg",
            emoji: "⭐",
            caption: "Con el amor de mi vida❤️",
            note: "Amo estar a tu lado ❤️",
            color: "#e8d8f8",
            rot: "2deg"
        },
...
(function initCodigoOjos() {
    ...
    const FRASE = "ERES LO MEJOR EN MI VIDA";
    const MAX_ERRORES = 6;
