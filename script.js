...
(function initMensajeSorpresa() {
  ...
  overlay.innerHTML = `
    <div class="sorpresa-card-pop">
      ...
      <div class="sorp-msg">
    Sonría siempre mi amor a pesar de las cosas negativas o tropiezos en el camino usted siempre saldrá adelante mi niña bonita❤️ <br>
      </div>
...
(function initCodigoOjos() {
    ...
    const FRASE = "LINDOTAAA MI MAESTRAA ";
    const MAX_ERRORES = 6;
