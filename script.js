...
(function initMensajeSorpresa() {
  ...
  overlay.innerHTML = `
    <div class="sorpresa-card-pop">
      ...
      <img class="sorp-foto" src="rebe3.jpeg" alt="Foto">
      ...
      <div class="sorp-msg">
     Esos ojitos preciosos tienen una belleza, sin igual, que no se apague nunca ese brillo mi amor ❤️<br>
      </div>
...
(function initCodigoOjos() {
    ...
    const FRASE = "TE QUIERO HOY MAÑANA Y SIEMPRE";
    const MAX_ERRORES = 6;
