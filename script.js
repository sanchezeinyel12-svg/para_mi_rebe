...
(function initMensajeSorpresa() {
  ...
  overlay.innerHTML = `
    <div class="sorpresa-card-pop">
      ...
      <div class="sorp-msg">
    Feliz de tener una mujer tan bella en mi vida, que me quiera , me respete que lo sea todo conmigo ❤️ <br>
      </div>
...
(function initMariposas() {
    ...
    const RAZONES = [
        {
            titulo: "Te quiero por ser tan unica ❤️ ",
            msg: "En la vida la sencillez vale más que algo complejo ❤️.",
            color: "#c04070",
            colorAla: "#e05080",
            colorCuerpo: "#7a1a3a"
        },
...
(function initCodigoOjos() {
    ...
    const FRASE = "ME ENCANTAS MUCHOTE MI MUJER";
    const MAX_ERRORES = 6;
