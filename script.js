...
(function initMensajeSorpresa() {
  ...
  overlay.innerHTML = `
    <div class="sorpresa-card-pop">
      ...
      <div class="sorp-msg">
      Quiero que sepa que no hay momento del dia que no piense en ti corazón , mis pensamientos están siempre en ti mi amorcito
      me importas mucho te quiero ver bien siempre y feliz conmigo su noviooooooo te quieroooo ❤️.<br>
      </div>
