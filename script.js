...
for (let i = 0; i < 8; i++) {
  setTimeout(spawnFraseEspecial, i * 500);
}
// Seguir spawneando cada 2.5s
setInterval(spawnFraseEspecial, 2500);
...
// ══════════════════════════════════════════════════════════════
//  MENSAJE ESPECIAL AL ENTRAR A CADA PANEL (console lovemsg)
// ══════════════════════════════════════════════════════════════
const PANEL_MSGS = [
  '🌊 Rebeca, eres el inicio de todo...',
  '📸 Cada foto contigo es un tesoro...',
  '✦ El cielo de nuestra historia...',
  '❤️ Cada foto, un latido de amor...',
  '📖 Cada página, un momento real...',
  '🌅 Nuestro horizonte juntos...',
...
addExtraStars(document.getElementById('p1'), 20);
addExtraStars(document.getElementById('p-carta'), 15);
addExtraStars(document.getElementById('p-book'), 12);
addExtraStars(document.getElementById('p4'), 10);
