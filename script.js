...
(function initMensajeSorpresa() {
  ...
  overlay.innerHTML = `
    <div class="sorpresa-card-pop">
      ...
      <div class="sorp-msg">
   Tu y yo siempre juntitos mi amor SIEMPRE❤️ <br>
      </div>
...
Recuerda siempre que todo mi amor te pertenece a ti corazón, todas mis acciones para ti

Desde que hemos iniciado este viaje juntos me ha confirmado que quiero estar contigo SIEMPRE Y SIEMPRE no veo con alguien más que no seas tu MI AMOR , en mil vidas te seguiria eligiendo a ti siempre 

No me cansaré nunca de expresarte lo que siento por TI y mi amor inmenso que cada día crece y crece más, es algo nuestro y es muy bonito mantenerlo creciendo siempre

Quiero que entiendas que yo estaré siempre para ti en las buenas y las malas, siempre estarán mis brazos abiertos para ti todo mi amor te quiero tanto mi niña preciosa
...
(function initPolaroid() {
    ...
    const POLAROIDS = [
        ...
        },
        {
            photo: "novia2.jpeg",
            emoji: "⭐",
            caption: "Mi niña chiquitita❤️",
            note: "Amo estar a tu lado ❤️",
            color: "#e8d8f8",
            rot: "2deg"
        },
...
(function initCodigoOjos() {
    ...
    const FRASE = "SIEMPRE TE ELEGIRE MI AMOR SIEMPRE";
    const MAX_ERRORES = 6;
    ...
    if (gano) {
        ...
        resultMsg.innerHTML = `
            <div class="codigo-win-photo">
                <img src="nv2.jpeg" alt="Mi princesa">
            </div>
           Como quiero a esta niña preciosa❤️<br>
