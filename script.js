...
(function initMensajeSorpresa() {
  ...
  overlay.innerHTML = `
    <div class="sorpresa-card-pop">
      ...
      <img class="sorp-foto" src="son.jpeg" alt="Foto">
      ...
      <div class="sorp-msg">
     Mi linda mujercita ❤️ Estoy tan feliz a tu lado, haces que mi niño interior este feliz contigo y esto va para muuuuuy largo PRIMERO DIOS ❤️<br>
      </div>
...
(function initCodigoOjos() {
    ...
    const FRASE = "ORGULLOSO DE TI MI NIÑA BONITA";
    const MAX_ERRORES = 6;
