...
(function initMensajeSorpresa() {
  ...
  overlay.innerHTML = `
    <div class="sorpresa-card-pop">
      ...
      <div class="sorp-msg">
     Sonriaaaa siempre que la vida se debe disfrutar.  y yo me encargaré de que esa sonrisa siempre este presente y ese brillo de sus
     ojitos no se apague nuncaaaaaa ❤️.<br>
      </div>
...
(function initMariposas() {
    ...
    const RAZONES = [
        {
            titulo: "Te quiero por ser como eres ❤️ ",
            msg: "La forma que tienes de ver las cosas de ser tú. De afrontar las cosas con una sonrisa, de ver el mundo de una forma tan bonita❤️.",
            color: "#c04070",
            colorAla: "#e05080",
            colorCuerpo: "#7a1a3a"
        },
        {
            titulo: "Te quiero por que me haces ser mejor persona  ❤️",
            msg: "Siempre te encargas de ayudarme , motivarme de estar ahí para mí siempre a pesar de tus cosas siempre hay tiempo para mí ❤️.",
            color: "#c9a84c",
            colorAla: "#f0c860",
            colorCuerpo: "#7a6030"
        },
        {
            titulo: "Te quiero por que en ti encontre la felicidad que tanto tiempo no tenía ",
            msg: "Desde que estás en mi vida, todo cambio. mis estados de animo. la forma como veo las cosas todos esos sentimientos cambiarion por que hoy tengo felicidad en mi corazon gracias a ti mi amorcito ❤️.",
            color: "#9b6bb9",
            colorAla: "#c9a8e8",
            colorCuerpo: "#3a1560"
        },
...
(function initCodigoOjos() {
    ...
    const FRASE = "ESOS OJITOS ME MATAN";
    const MAX_ERRORES = 6;
    ...
    function verificarVictoria() {
        ...
        if (gano) {
            juegoTerminado = true;
            resultMsg.innerHTML = "Lo lograste mi princesaaa❤️<br><span style='font-size:0.8rem; color:var(--text-dim)'>Tu sabes lo que me encantan a mi esos ojitos ❤️ </span>";
